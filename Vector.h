...
public:
    ...
    private:
        ...
        size_t count;
    public:
        IteratorX() : ptr{ nullptr }, end { nullptr },count{ 0 } {}
        IteratorX(pointer pt, pointer end) : ptr{ pt }, end{ end }, count{ 0 }{}
        IteratorX(pointer pt, pointer end,size_t count) : ptr{ pt }, end{ end }, count{ count }{}
